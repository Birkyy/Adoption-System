        ...
        <div className="flex flex-row justify-end gap-5 items-center">
          ...
          {user ? (
            ...
            <>
              ...
              {/* 2. Profile Icon */}
              <button title={`Logged in as ${user.name}`}>
                <NavLink to="/profile">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
